...
\subsection{\albert{DEMT Reconstructions}}\label{demt}
...
\subsection{\albert{AWSoM Simulations}}\label{awsom} 
...
\subsection{\albert{Tracing Results Along Magnetic Fieldlines}}\label{trace} 
...
In Section \ref{resu}, the results of both the DEMT and AWSoM models in the distinct magnetic strucures are statistically analysed. \albert{As shown below, classification of legs from type 0 through II allows studying the streamer belt in three distinct, progressively outer layers.}
...
\noindent
where $s$ is the position along \albert{the flux tube} and the \albert{power quntities} are in units of $[{\rm erg\,sec^{-1}\,cm^{-3}}]$.
...
\hline
0    & 1&24 &(\Mi&19\%)  &   \albert{\bf 7}&\albert{\bf 1} &(\Pl&~3\%) &   1&09 &(\Pl&24\%) \\
...
{A comparison of the results between the two rotations shows that, compared to CR-2082, target rotation CR-2208 was characterized by \albert{$\approx 10-20\%$} lower values of the electron density at the coronal base, $\approx 5-30\%$ larger values of density scale height, and \albert{$\approx 5-25\%$} larger values of the electron temperature.} 
...
{For the two target rotations, Table \ref{tabla_comp} summarizes a quantitative comparative analysis between the results of the DEMT and AWSoM models \albert{based on the results shown in Figures \ref{histos_2082} and \ref{histos_2208}}. The DEMT results are expressed as absolute values, while the ASWSoM results are informed as a percentual variation relative to the corresponding result for DEMT. The following major results can be drawn.}
...
\hline
CR-2082\\
I    & 1&15 &(\Mi&14\%)  &   7&5 &(\Pl&~8\%) &   1&25 &(\Mi&\albert{\bf 10}\%) \\
II   & 0&99 &(\Mi&25\%)  &   \albert{\bf 9}&9 &(\Mi&~2\%) &   1&36 &(\Mi&~2\%) \\
III  & 0&65 &(\Mi&15\%)  &   7&6 &(\Mi&~8\%) &   0&97 &(\Mi&~9\%) \\
\hline          
CR-2208\\
I    & 1&03 &(\Pl&~6\%)  &   9&7 &(\Mi&~8\%) &   1&55 &(\Mi&17\%) \\
II   & 0&79 &(\Pl&~9\%)  &  11&8 &(\Mi&14\%) &   1&58 &(\Mi&~8\%) \\
III  & 0&55 &(\Pl&~\albert{\bf 2}\%)  &   8&6 &(\Mi&16\%) &   1&04 &(\Mi&11\%) \\
\end{tabular}
...
\section{\albert{Discussion and Conclusions}}\label{discu} 
