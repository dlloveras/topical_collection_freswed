...
\begin{abstract}
{We carry out a study of the global three-dimensional (3D) structure of the electron density and temperature of the quiescent inner solar corona ($r<1.25\,\mrsun$) by means of tomographic reconstructions and magnetohydrodynamic simulations. We use differential emission measure tomography (DEMT) and the Alfv\'en Wave Solar Model (AWSoM), in their latest versions. Two target rotations were selected from the solar minimum between \edit{Solar Cycles} (SCs) 23 and 24 and the declining phase of SC 24. We report in quantitative detail on the 3D thermodynamic structure of the core and outer layers of the streamer belt, and of the high latitude coronal holes (CH), as revealed by the DEMT analysis. We report on the presence of two types of structures within the streamer belt, loops with temperature decreasing/increasing with height (dubbed down/up loops), as reported first in previous DEMT studies. We also estimate the heating energy flux required at the coronal base to keep these structures stable, found \edit{to be of order} $10^5\,\erg\,\cminvs\,\s^{-1}$, consistently with previous DEMT and spectroscopic studies. We discuss how these findings are consistent with coronal dissipation of Alfvén waves. We compare the 3D results of DEMT and AWSoM in distinct magnetic structures. We show that the agreement between the products of both techniques is the best so far, with an overall agreement $\lesssim 20\%$, depending on the target rotation and the specific coronal region. In its current implementation the ASWsoM model \edit{cannot} reproduce down loops though. Also, in the source region of the fast and slow components of the solar wind, the electron density of the AWSoM model increases with latitude, opposite to the trend observed in DEMT reconstructions.}
\end{abstract}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.495\textwidth,clip=]{Grispoint_2082_demt_paper_test_Rpoint-map222.pdf}
\includegraphics[width=0.495\textwidth,clip=]{Grispoint_2208_demt_paper_test_Rpoint-map222.pdf}
\includegraphics[width=0.495\textwidth,clip=]{Highpoint_2082_demt_paper_doble_error_Rpoint-map222.pdf}
\includegraphics[width=0.495\textwidth,clip=]{Highpoint_2208_demt_paper_doble_error_Rpoint-map222.pdf}
\includegraphics[width=0.495\textwidth,clip=]{histo_cr2082_full_conajuste_doble_errorhighpoints2.pdf}
\includegraphics[width=0.495\textwidth,clip=]{histo_cr2208_full_conajuste_doble_errorhighpoints2.pdf}
...
{For both rotations, the population of type 0 (\edit{small-closed down}) legs peaks at the core of the streamer belt, around the equator in the case of \edit{CR 2082}, and towards the southern hemisphere in the case of \edit{CR 2208}.} This kind of structure was originally found by \citet{huang_2012} and their existence was shown to be anti-correlated with the solar activity level around the solar minimum between {SCs 23 and 24} by \citet{nuevo_2013}. Later on, \citet{lloveras_2017} showed {that} equatorial down loops in streamers were also to be found in the deep minimum between SCs {23 and 24}. Here, we verify the existence of this type of structure for the two rotations. The relatively smaller population of down legs seen in \edit{CR 2208}, as compared to \edit{CR 2082}, is consistent with the aforementioned results by \citet{nuevo_2013}. {Type I (small-closed-up) legs are present at all latitudes within the streamer belt. Their population peaks in the mid-latitudes of both hemispheres for \edit{CR 2082}, and in the mid-latitudes of the northern hemisphere for \edit{CR 2208}. The latitude distribution of legs of type 0 and I in \edit{CR 2082} is consistent to the distribution of down and up loops of CR 2081 in the analysis by \citet{nuevo_2013}, which did not place any limits on the latitude location of the analysed structures.}

{Type II (large up) legs are mostly very large \edit{transequatorial} field lines forming the envelope of the streamer belt (the requirement of footpoints located beyond mid-latitudes was included precisely to select this kind of loop). Finally, type III (open) legs populate the high latitude CHs.}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.495\textwidth,height=0.25\textwidth,clip=]{histo_cr2082_full_doble_errortriple_gradt.pdf}
\includegraphics[width=0.495\textwidth,height=0.25\textwidth,clip=]{histo_cr2208_full_doble_errortriple_gradt.pdf}
\caption{Frequency histograms of the temperature radial gradient for {the four types of legs} in Figure \ref{rpoint_demt} (using the same \edit{colour} code) for \edit{CR 2082} (left panel) and \edit{CR 2208} (right panel).}
\label{gradt_demt}
\end{center}
\end{figure} 

Figure \ref{gradt_demt} shows frequency histograms of $\dr\Tm$ for legs of type 0, I, II, and III. The lack of population around values close to zero is due to the requirement $|\rhoTr| > 0.5$ which discards quasi-isothermal legs. For both rotations, the median value of the temperature radial gradient is {${\rm Md}\left(\dr\Tm\right) \approx -2.2$, $+2.3$, $+2.4$, and $+2.3\,\MK/\mrsun$, for legs of type 0, I, II, and III, respectively.}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_streamer_down_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_streamer_down_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_streamer_down_Tm_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_streamer_up_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_streamer_up_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_streamer_up_Tm_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_bound_up_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_bound_up_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_bound_up_Tm_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_CH_up_conajustene_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_CH_up_conajustelambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_2208_fulldemt_CH_up_conajusteTm_2.pdf}
\caption{{Statistical distribution of {DEMT results for rotations \edit{CR 2082} (blue) and \edit{CR 2208} (red)} traced along legs of type 0, I, II, and III (from top to bottom), as defined in Section \ref{trace}. From left to right: {electron density $\NCB\equiv\sqravgN(r=1.055\,\mrsun)$,} electron density scale height $\lN$, {and loop-averaged temperature $\aTm$. In each panel} the median value $m$ is indicated.} }
\label{histos_fulldemt}
\end{center}
\end{figure} 

{For both rotations, Figure \ref{histos_fulldemt} shows, in a statistical fashion, the DEMT results traced along field lines discriminated by leg type}. From top to bottom {results are shown for} type 0 to type III {legs}{, respectively}. From left to right the panels show the statistical distribution of the electron density value $\NCB \equiv \sqravgN(r=1.055)\edit{[{\rm cm}^{-3}]}$, {the scale height $\lN$, and the height-averaged (along the leg) electron temperature $\aTm \edit{[{\rm MK}]}$}, {with the median value $m$ indicated in each plot}.
...
III  & 0&66 &(\Mi&{21}\%)  &   7&7 &(\Pl&15\%) &   0&97 &(\Pl&{17}\%) \\
\hline          
\end{tabular}
\caption{Median value (indicated as Md) of the statistical distribution of $\NCB$, $\lN$, and $\aTm$ for each coronal type of legs defined in Section \ref{trace}. For \edit{CR 2082}, values are expressed in absolute terms, while for \edit{CR 2208} they are {given} as a percentual variation relative to the \edit{CR 2082} value {in the parentheses.}}
\label{tabla_demt}
\end{table}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.495\textwidth,clip=]{Grispoint_2082_awsom_paper_test_Rpoint-map2.pdf}
\includegraphics[width=0.495\textwidth,clip=]{Grispoint_2208_awsom_paper_test_Rpoint-map222.pdf}
\includegraphics[width=0.495\textwidth,clip=]{Highpoint_2082_awsom_paper_cr2082_up_Rpoint-map222.pdf}
\includegraphics[width=0.495\textwidth,clip=]{Highpoint_2208_awsom_paper_cr2208_up_Rpoint-map222.pdf}
...
To \edit{characterise} the results of the AWSoM model in distinct magnetic structures, its results for electron density and temperature were traced along its magnetic field lines. For each field line leg, the results were then fit to Equations \ref{Nfit} and \ref{Tfit}{, considering only data points above heliocentric height $1.055\,\mrsun$. We then classified the traced legs into types I, II, and III, according to the criteria described in Section \ref{trace}.  Legs of type 0 are not included for AWSoM as it currently can not simulate down loops, as discussed in Section \ref{discu}.}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_streamer_up_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_streamer_up_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_streamer_up_Tm_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_bound_up_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_bound_up_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_bound_up_Tm_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_CH_up_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_CH_up_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2082_demt_awsom_CH_up_Tm_2.pdf}
\caption{{Statistical distribution {of the results of the \edit{DEMT reconstruction} (solid line-style) and AWSoM (dashed-line style)} traced along legs of type I, II, and III (from top to bottom), as defined in {Section \ref{trace}.} From left to right: electron density at the lowest coronal height of the AWSoM model $\Ne(r=1.055\,\mrsun)$, electron density scale height $\lN$, and leg-averaged electron temperature $\aTm$. In each panel the median {values $m$ are} indicated.}}
\label{histos_2082}
\end{center}
\end{figure} 

{For both target rotations, the top panels of Figure \ref{rpoint_awsom} show the latitude-longitude location (at heliocentric height $1.105\,\mrsun$) of all traced field line legs for which criterion (i) of Section \ref{trace} is met. That criterion is adapted here, requiring that at least five voxels of the tomographic grid are threaded by the leg. Open legs are indicated in \edit{grey} \edit{colour} and closed ones in black \edit{colour}. For each leg, the fits to tomographic temperature and density were applied, as given by Equations \ref{Nfit} and \ref{Tfit}. Considering the AWSoM data points and the resulting fits along each leg, the bottom panels of Figure \ref{rpoint_awsom} show the latitude-longitude location of the subset for which also both criteria (ii) and (iii) of Section \ref{trace} are met. Using a three-\edit{colour} code, type I, II, and III legs are shown in red, magenta, and cyan \edit{colour}, respectively. This figure {can be compared} with the corresponding Figure \ref{rpoint_demt} for DEMT results. {The AWSoM maps are more densely populated} than those of \edit{the DEMT}. This is due to the 3D MHD model having {spatially smoother distributions of electron density and temperature than those of \edit{the DEMT}}.}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_streamer_up_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_streamer_up_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_streamer_up_Tm_2.pdf}\\
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_bound_up_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_bound_up_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_bound_up_Tm_2.pdf}\\
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_CH_up_conajuste_ne_1055_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_CH_up_conajuste_lambda_n_2.pdf}
\includegraphics[width=0.31\textwidth,clip=]{histo_2208_demt_awsom_CH_up_conajuste_Tm_2.pdf}
\caption{Same as Figure \ref{histos_2082} for \edit{CR 2208}.}
\label{histos_2208}
\end{center}
\end{figure}

{For \edit{CR 2082}, Figure \ref{histos_2082} shows the statistical distribution of the results of the \edit{DEMT reconstruction} (solid line-style) and AWSoM (dashed line-style) model traced along legs of type I, II, and III (from top to bottom), as defined in Section \ref{trace}. Figure \ref{histos_2208} shows the same analysis for \edit{CR 2208}.} %From left to right: electron density at the lowest coronal height of the AWSoM model $\NCB\equiv\Ne(r=1.055\,\mrsun)$, electron density scale height $\lN$, and leg-averaged electron temperature $\aTm$. In each panel the median values $m$ are indicated. Figure \ref{histos_2208} shows the same analysis for rotation \edit{CR 2208}.}

{For the two target rotations, Table \ref{tabla_comp} \edit{summarises the} quantitative comparative analysis between the results of the \edit{DEMT reconstruction and AWSoM model} {based on the results shown in Figures \ref{histos_2082} and \ref{histos_2208}}. The DEMT results are expressed as absolute values, while the AWSoM results are informed as a percentual variation relative to the corresponding result for \edit{the} DEMT.}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.495\textwidth,clip=]{perfil_paper_ne_cr2082_up.pdf}
\includegraphics[width=0.495\textwidth,clip=]{perfil_paper_te_cr2082_up.pdf}
\includegraphics[width=0.495\textwidth,clip=]{perfil_paper_ne_cr2208_up_conajuste.pdf}
\includegraphics[width=0.495\textwidth,clip=]{perfil_paper_te_cr2208_up_conajuste.pdf}
\caption{{Average fits to $\Ne(r)$ (left panels) and $T_e(r)$ (right panels) for legs of {type I ({orange}), II ({red}), and III (cyan)}, for \edit{CR 2082} (top panels) and \edit{CR 2208} (bottom panels). Solid lines correspond to DEMT results while dashed lines correspond to AWSoM results.}}
