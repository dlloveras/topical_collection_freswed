...
\diego{
Some technical improvements were applied in this work, a 3D regularization scheme was used instead of the latitude-longitude regularization scheme used in previous DEMT reconstructions. This implies that the results of the tomography are now more reliable at lower heights and limit-induced artifacts are minimized. For each instrument, the DEMT analysis involves a cross-validation study to determine the optimal level of regularization. This level is different for each wavelength band and is sensitive to}
