...
\def\albert#1{\textcolor{blue}{ALBERT: #1}}
\def\fede#1{\textcolor{green}{FEDE: #1}}
...
%\temp{que quede claro que de ahora en mas solo consideramos ajustes de loops up, es decir pearson temp > 0.5 debido a que awsom solo tiene up.}
