...
\begin{figure}%[h]
\begin{center}
\includegraphics[width=0.495\textwidth,clip=]{figs/perfil_paper_cr2082_ne.eps}
\includegraphics[width=0.495\textwidth,clip=]{figs/perfil_paper_cr2082_te.eps}
\includegraphics[width=0.495\textwidth,clip=]{figs/perfil_paper_cr2208_ne.eps}
\includegraphics[width=0.495\textwidth,clip=]{figs/perfil_paper_cr2208_te.eps}
\caption{Latitude-longitude location of field lines meeting the criteria listed in Section \ref{trace} traced with DEMT results, at heights $1.105\,\mrsun$, for CR-2082(left panel) and CR-2208 (right panel). Different colors identify diverse thermodynamical and magnetic structures, as described in the text.}
\label{rpoint}
\end{center}
\end{figure} 
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_lowlat_ncb.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_midlat_S_ncb.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_lowlat_lambda.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_midlat_S_lambda.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_lowlat_tm.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_midlat_S_tm.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_lowlat_bcb.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_midlat_S_bcb.pdf}
\caption{
...
\begin{figure}[ht!]
\begin{center}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_L_ncb.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_H_ncb.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_L_lambda.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_H_lambda.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_L_tm.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_H_tm.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_L_bcb.pdf}
\includegraphics[width=0.495\textwidth,clip=]{test_comp_open_S_H_bcb.pdf}
