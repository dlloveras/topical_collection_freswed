...
\caption{Comparative statistical distributions of (from left to right): the coronal base electron density $N_e(r=1.055\,\mrsun)$, the electron density scale height $\lN$ and the average electron mean temperature $\aTm$, along all field lines traced in the streamer (type I, top panels), the boundary of the streamer (type II, mid panels) and the Coronal Holes (type III, bottom panels). for CR-2082. DEMT results of CR2082 are shown in blue while those of CR2208 in red. In each panel the median $m$ is indicated.}
